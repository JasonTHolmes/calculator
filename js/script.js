...
numOne.addEventListener('onClick', add);
numTwo.addEventListener('onClick', add);
numThree.addEventListener('onClick', add);
numFour.addEventListener('onClick', add);
numFive.addEventListener('onClick', add);
numSix.addEventListener('onClick', add);
numSeven.addEventListener('onClick', add);
numEight.addEventListener('onClick', add);
numNine.addEventListener('onClick', add);
numZero.addEventListener('onClick', add);
numDoubleZero.addEventListener('onClick', add);
numPlus.addEventListener('onClick', add);
num.addEventListener('onClick', add);
num.addEventListener('onClick', add);
num.addEventListener('onClick', add);
num.addEventListener('onClick', add);
num.addEventListener('onClick', add);
